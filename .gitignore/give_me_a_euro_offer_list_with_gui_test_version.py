...
def offers_via_skype_to_adrian():
    ...
    # Single chat
    ch = sk.contacts["live:ultiglobal1"].chat # 1-to-1 conversationch.sendMsg(content) # plain-text message #
    # https://github.com/Terrance/SkPy/issues/173
    msg = ch.sendMsg(
...
#print(df_clients.loc["Korsit", "Skype Adress"])
###df_clients.loc[0]
...
#        print("Failed with exception [%s]" % exc_type.__name__)
    ...
    check_buttons_dict = {
            "Korsit":[twovar, new_list_6_eur, new_list_6_pln],
            "Your Games":[threevar, new_list_7_eur],
            "Brolexy":[fourvar, new_list_6_eur],
            "Mom's Basement":[fivevar, new_list_6_eur],
            "Igro Shop":[sixvar, new_list_7_eur],
            "HVK":[sevenvar, new_list_7_eur],
            "Other clients":[eightvar, new_list_7_eur]
            }
    check_buttons_list = [twovar, threevar, fourvar, fivevar, sixvar, sevenvar, eightvar]
    
    #print(check_buttons_dict["Korsit"])
    ...
    #                    print(repr(login_from_clients_dict[dict_name])) # test 
                    ...
                    """
                    if (dict_name != "Korsit" and 
                        dict_name == "Your Games" and
                    ...
                    """
                    "Korsit" client needs to get a specific offer list
                    """
                    if (dict_name == "Korsit" and 
                        dict_name != "Other clients" and
                        df_clients.loc[dict_name, "group skype adress"] != "NaN"
